      ...
      <div>
          <div 
              ...
              <div className='overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500'>
                <Link href='/' className='h-14 w-14 mr-3 border-2 realtive rounded-full border-[#ADB7BE] hover:border-white group/link'>
                ...
                <Link href='/' className='h-14 w-14 border-2 realtive rounded-full border-[#ADB7BE] hover:border-white group/link'>
